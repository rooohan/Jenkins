...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\subtract.exe
...
PRODUCT_NAME              = subtract
MAKEFILE                  = subtract.mk
MATLAB_ROOT               = D:\software\POLYSP~1\R2020a
...
COMPILER_COMMAND_FILE     = subtract_comp.rsp
CMD_FILE                  = subtract.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\subtract.exe
...
DEFINES_STANDARD = -DMODEL=subtract -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
{$(START_DIR)\subtract_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\subtract_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\subtract_grt_rtw\rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\subtract_grt_rtw\rtGetInf.cpp


rtGetNaN.obj : $(START_DIR)\subtract_grt_rtw\rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\subtract_grt_rtw\rtGetNaN.cpp


rt_nonfinite.obj : $(START_DIR)\subtract_grt_rtw\rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\subtract_grt_rtw\rt_nonfinite.cpp
...
rt_main.obj : $(MATLAB_ROOT)\rtw\c\src\common\rt_main.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(MATLAB_ROOT)\rtw\c\src\common\rt_main.cpp
